package com.dibby.bebek.fragment.caraBertenak;
...
/**
 * Created by dibby on 15/02/2018.
 */

public class FragmentNewBorn extends Fragment{

    private OnFragmentInteractionListener listener;

    public static FragmentNewBorn newInstance(){
        return new FragmentNewBorn();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(
                R.layout.fragment_new_born, container, false
        );
        String text1 = getResources().getString(R.string.dod_par1);
        String text2 = getResources().getString(R.string.dod_par2);
        String text3 = getResources().getString(R.string.dod_par3);
        String text4 = getResources().getString(R.string.dod_par4);
        String text5 = getResources().getString(R.string.dod_par5);
        String text6 = getResources().getString(R.string.dod_par6);
        String text7 = getResources().getString(R.string.dod_par7);
        String text8 = getResources().getString(R.string.dod_par8);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener){
            listener = (FragmentNewBorn.OnFragmentInteractionListener) context;
        } else {
