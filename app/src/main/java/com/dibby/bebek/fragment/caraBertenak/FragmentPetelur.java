...
public class FragmentPetelur extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String text1 = getResources().getString(R.string.pete_par1);
        String text2 = getResources().getString(R.string.pete_par2);
        String text3 = getResources().getString(R.string.pete_par3);
        String text4 = getResources().getString(R.string.pete_par4);
        String text5 = getResources().getString(R.string.pete_par5);
        String text6 = getResources().getString(R.string.pete_par6);
        String text7 = getResources().getString(R.string.pete_par7);
        String text8 = getResources().getString(R.string.pete_par8);
