...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addContact(new Gejala("G01","Unggas terlihat mengantuk ", "1", 0.28));
        db.addContact(new Gejala("G02","Keluar lendir , kental berwarna kekuningan dan berbau dari hidung", "1",0.39));
        db.addContact(new Gejala("G03","Muka dan mata bengkak ", "1",0.37));
        db.addContact(new Gejala("G04","Terdapat kerak dihidung", "9533333333",0.31));
        db.addContact(new Gejala("G05","Napsu makan menurun hingga tembolok kosong saat diraba", "9533333333",0.48));
        db.addContact(new Gejala("G06","Mengorok", "9533333333",0.44));
        db.addContact(new Gejala("G07","Pertumbuhan lambat", "9533333333",0.45));
        db.addContact(new Gejala("G08","Kotoran encer dan bercampur butiran-butiran putih seperti kapur", "9",0.54));
        db.addContact(new Gejala("G09","Bulu dubur melekat satu sama lain", "3",0.23));
        db.addContact(new Gejala("G10","sayap berwarna keabuan", "3",0.3));
        db.addContact(new Gejala("G11","Badan menjadi menunduk", "3",0.46));
        db.addContact(new Gejala("G12","Sayap terkulai", "3",0.29));
        db.addContact(new Gejala("G13","Mata menutup", "3",0.25));
        db.addContact(new Gejala("G14","Sayap berwarna biru", "3",0.53));
        db.addContact(new Gejala("G15","Mata unggas terlihat lesu", "3",0.4));
        db.addContact(new Gejala("G16","Sesak nafas", "3",0.38));
        db.addContact(new Gejala("G17","Berak mengalami mencret", "1",0.36));
        db.addContact(new Gejala("G18","Kotoran berwarna kuning, coklat atau hijau berlendir dan berbau busuk", "3",0.33));
        db.addContact(new Gejala("G19","Sayap dan pial bengkak serta kepala berwarna kebiruan", "3",0.23));
        db.addContact(new Gejala("G20","Suka menggeleng-gelengkan kepala", "3",0.23));
        db.addContact(new Gejala("G21","Persendian kaki dan sayap bengkak disertai kelumpuhan", "3",0.21));
        db.addContact(new Gejala("G22","Batuk-batuk", "3",0.57));
        db.addContact(new Gejala("G23","Napas berbunyi", "3",0.24));
        db.addContact(new Gejala("G24","Produksi telur turun", "2",0.56));
        db.addContact(new Gejala("G25","Bulu kasar", "3",0.58));
        db.addContact(new Gejala("G26","Unggas mengalami diare", "3",0.26));
        db.addContact(new Gejala("G27","Kornea menjadi keruh", "3",0.29));
        db.addContact(new Gejala("G28","Otot tubuh gemetar", "6",0.52));
        db.addContact(new Gejala("G29","Kelumpuhan hingga gangguan saraf yang dapat menyebabkan kejang-kejang dan leher terpuntir", "3",0.5));
        db.addContact(new Gejala("G30","Bulu tampak kusam", "3",0.27));
        db.addContact(new Gejala("G31","Peradangan di sekitar dubur dan kloaka, biasanya unggas akan mematoki duburnya sendiri", "3",0.46));
        db.addContact(new Gejala("G32","Jika tidur, paruhnya menempel di lantai dan keseimbangan tubuhnya terganggu", "3",0.24));
        db.addContact(new Gejala("G33","Bersin", "8",0.43));
        db.addContact(new Gejala("G34","Terengah-engah", "3",0.31));
