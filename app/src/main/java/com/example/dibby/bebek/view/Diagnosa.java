...
//            case R.id.g1:
//                if (checked) {
//                    mGejala.add(db.getContact("G01"));
//                    Log.i("arr", "a" + mGejala);
//                    Gejala g = mGejala.get(i);
//                    oo[y] = g.getAngka();
//                    Log.i("Gejala", "Angka = " + oo[0]);
//                    i++;
//                    y++;
//                } else {
//
...
//        }
    ...
    public void checkPenyakit(){
        ...
        Log.i("bobot1", "bobot = " + Arrays.toString(bobotP01));
        Log.i("bobot2", "bobot = " + Arrays.toString(bobotP02));
        Log.i("bobot3", "bobot = " + Arrays.toString(bobotP03));
        Log.i("bobot4", "bobot = " + Arrays.toString(bobotP04));
